...
public class CuentasClientesControlador {
    ...
    @Operation(summary = "Obtener cuenta-cliente por ID",
               description = "Devuelve los datos de la cuenta-cliente especificada por su ID")
    @ApiResponses({
      @ApiResponse(responseCode = "200", description = "Cuenta-cliente encontrada",
        content = @Content(schema = @Schema(implementation = CuentasClientesRespuestaDTO.class))),
    ...
    public ResponseEntity<CuentasClientesRespuestaDTO> obtenerPorId(
        @Parameter(description = "ID de la cuenta-cliente", required = true)
    ...
    @Operation(summary = "Obtener cuenta-cliente por número de cuenta",
               description = "Devuelve los datos de la cuenta-cliente a partir de su número de cuenta")
    @ApiResponses({
      @ApiResponse(responseCode = "200", description = "Cuenta-cliente encontrada",
        content = @Content(schema = @Schema(implementation = CuentasClientesRespuestaDTO.class))),
      @ApiResponse(responseCode = "404", description = "No se encontró la cuenta-cliente")
    ...
    @Operation(summary = "Obtener cuenta-cliente por cliente y número",
               description = "Devuelve la cuenta-cliente filtrando por ID de cliente y número de cuenta")
    @ApiResponses({
      @ApiResponse(responseCode = "200", description = "Cuenta-cliente encontrada",
        content = @Content(schema = @Schema(implementation = CuentasClientesRespuestaDTO.class))),
      @ApiResponse(responseCode = "404", description = "No se encontró la cuenta-cliente")
    ...
    @Operation(summary = "Crear nueva cuenta-cliente",
               description = "Registra una nueva relación cuenta-cliente")
    @ApiResponses({
      @ApiResponse(responseCode = "201", description = "Cuenta-cliente creada",
        content = @Content(schema = @Schema(implementation = CuentasClientesRespuestaDTO.class))),
      @ApiResponse(responseCode = "400", description = "Datos inválidos")
    })
    @PostMapping
    public ResponseEntity<CuentasClientesRespuestaDTO> crear(
        @Parameter(description = "Payload para crear la cuenta-cliente", required = true)
        @Valid @RequestBody CuentasClientesSolicitudDTO dto) {
    ...
    @Operation(summary = "Actualizar cuenta-cliente",
               description = "Modifica los datos de una cuenta-cliente existente")
    @ApiResponses({
      @ApiResponse(responseCode = "200", description = "Cuenta-cliente actualizada",
        content = @Content(schema = @Schema(implementation = CuentasClientesRespuestaDTO.class))),
      @ApiResponse(responseCode = "404", description = "No se encontró la cuenta-cliente"),
      @ApiResponse(responseCode = "400", description = "Datos inválidos")
    })
    ...
    public ResponseEntity<CuentasClientesRespuestaDTO> actualizar(
        ...
        @Parameter(description = "Payload con datos a actualizar", required = true)
        @Valid @RequestBody CuentasClientesSolicitudDTO dto) {
    ...
    @Operation(summary = "Desactivar cuenta-cliente",
               description = "Marca la cuenta-cliente como inactiva")
    @ApiResponses({
    ...
    @Operation(summary = "Activar cuenta-cliente",
               description = "Marca la cuenta-cliente como activa")
    @ApiResponses({
